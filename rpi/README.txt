...
NOTE: The Raspberry Pi will automatically reboot during these steps, so make sure you've
      saved any other work you've been doing before you perform these steps.
 
Make sure your Raspberry Pi is connected to the Internet either through an Ethernet cable
or through a WiFi link.
...
Press "y" when prompted "Do you want to continue [Y/n]?
...
--------------
If you are running a recent Raspberry Pi (3.18 kernel or higher) you will also need to
...
Type in this command in a bash shell:
...
Now check if the GrovePi is working:
